...
class LearningModel(object):
    ...
    def __init__(self, m_size, normalize, use_recurrent, brain, seed):
        ...
        self.brain = brain
        self.vector_in = None
        self.global_step, self.increment_step, self.steps_to_increment = self.create_global_steps()
        self.visual_in = []
    ...
    def create_global_steps():
        ...
        steps_to_increment = tf.placeholder(shape=[], dtype=tf.int32, name="steps_to_increment")
