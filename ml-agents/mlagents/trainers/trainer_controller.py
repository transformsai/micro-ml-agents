...
class TrainerController(object):
    ...
    def _reset_env(self, env: SubprocessEnvManager):
    ...
    def start_learning(self, env_manager: SubprocessEnvManager, trainer_config):
    ...
    def take_step(self, env: SubprocessEnvManager):
        if self.meta_curriculum:
        ...
        for last_brain_info in last_brain_infos:
            ...
            new_steps.append((
                take_action_vector, take_action_memories, take_action_text, take_action_value
            ))
        ...
        for i, new_info in enumerate(new_brain_infos):
            for brain_name, trainer in self.trainers.items():
                ...
                trainer.add_experiences(
                    last_brain_infos[i], new_info, new_take_action_outputs[i][brain_name]
                )
        ...
        for brain_name, trainer in self.trainers.items():
            ...
            if (
                ...
                if self.train_model and trainer.get_step <= trainer.get_max_steps:
                    trainer.increment_step_and_update_last_reward(len(new_steps))
